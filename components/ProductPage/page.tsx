...
import { productType } from "../ui/interface";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
              ...
              <Card>
                <CardContent className="flex flex-col aspect-square items-center justify-center p-2">
                  <img
                    src={imgUrl}
                    alt={"Product detail"}
                    className="h-[320px] md:h-[480px] relative rounded-xl"
                  />
                </CardContent>
              </Card>
            </div>
...
const ProductPreview: React.FC<CarouselProps> = ({
  product,
  setIndex,
  selectedIdx,
}) => {
        ...
        return (
          <div key={`preview-${imgUrl}`} className="">
            <img
              ...
              } object-contain w-[120]px h-[120px] md:w-[200px] md:h-[200px] relative rounded-xl`}
            />
          </div>
        );
      })}
